...
Source0  : https://cran.r-project.org/src/contrib/fBasics_4041.97.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724077705
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/fBasics/libs/fBasics.so
/V4/usr/lib64/R/library/fBasics/libs/fBasics.so
